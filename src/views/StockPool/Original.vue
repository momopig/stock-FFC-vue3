<template>
  <div class="stock-pool-container">
              ...
              <div class="triangle-layout">
                <div class="triangle-top">
                  ...
                  <span
                    class="value"
                    :style="{
                      color: getQuoteColor(insightsData.selfAvgChange),
                    }"
                  >
                ...
                <div class="triangle-bottom">
                  <div class="triangle-left">
                    ...
                    <span
                      class="value"
                      :style="{
                        color: getQuoteColor(insightsData.selfMaxChange),
                      }"
                    >
                  ...
                  <div class="triangle-right">
                    ...
                    <span
                      class="value"
                      :style="{
                        color: getQuoteColor(insightsData.selfMinChange),
                      }"
                    >
              ...
              <div class="triangle-layout">
                <div class="triangle-top">
                  ...
                  <span
                    class="value"
                    :style="{
                      color: getQuoteColor(insightsData.todayAvgChange),
                    }"
                  >
                ...
                <div class="triangle-bottom">
                  <div class="triangle-left">
                    ...
                    <span
                      class="value"
                      :style="{
                        color: getQuoteColor(insightsData.todayMaxChange),
                      }"
                    >
                  ...
                  <div class="triangle-right">
                    ...
                    <span
                      class="value"
                      :style="{
                        color: getQuoteColor(insightsData.todayMinChange),
                      }"
                    >
    ...
    <div class="search-title">
      ...
      <el-date-picker
        v-model="filterParams.snapshot_date"
        type="date"
        ...
        @change="searchHandler"
      />
      <el-button class="search-btn" type="primary" @click="searchHandler"
        >搜索</el-button
      >
      <el-button class="search-btn" @click="reset">重置</el-button>
      <el-button class="add-stock-btn" type="primary" @click="addStockFn">
        添加股票
      </el-button>
    </div>
        ...
        stockList.value.forEach((stock) => {
          ...
          stock.change_rate =
            quote.change_rate != null
              ...
              : stock.change_rate;
          stock.turnover_rate =
            quote.turnover_rate != null
              ? Number(quote.turnover_rate)
              : stock.turnover_rate;
          stock.volume_ratio =
            quote.volume_ratio != null
              ? Number(quote.volume_ratio)
              : stock.volume_ratio;
          ...
          if (
            stock.initial_price &&
            stock.last_price &&
            stock.initial_price > 0
          ) {
            stock.selfChangeRate =
              ((stock.last_price - stock.initial_price) / stock.initial_price) *
              100;
          }
        });
