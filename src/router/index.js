...
const routes = [
  ...
  { path: '/trading-strategy/execution', component: lazy(() => import('@/views/TradingStrategy/StrategyList/index.vue'))},
  { path: '/trading-strategy/execution/usage', component: lazy(() => import('@/views/TradingStrategy/StrategyUsage/index.vue'))},
